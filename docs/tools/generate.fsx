...
let githubLink = "http://github.com/talbottmike/TalBot"

// Specify more information about your project
let info =
  [ "project-name", "TalBot"
    "project-author", "Mike Talbott"
    "project-summary", "A bot for posting status messages to Slack and responding to Slack posts."
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/TalBot" ]
